          ...
          <div className="lg:col-span-2 bg-white rounded-2xl border border-gray-100 shadow-sm overflow-hidden">
            ...
            <div className="divide-y divide-gray-50">
              {recentNotes.length === 0 && (
                <div className="p-8 text-center text-gray-400 text-sm">No notes uploaded yet. Start by uploading a PDF or recording a lecture!</div>
              )}
          ...
          <div className="bg-white rounded-2xl border border-gray-100 shadow-sm overflow-hidden">
            ...
            <div className="p-4 space-y-3">
              {upcomingTests.length === 0 && (
                <div className="p-4 text-center text-gray-400 text-sm">No upcoming tests. Create one from Self Test!</div>
              )}
          ...
          <div className="bg-white rounded-2xl border border-gray-100 shadow-sm p-5">
            ...
            <div className="space-y-4">
              {studyProgress.length === 0 && (
                <div className="text-center text-gray-400 text-sm py-4">No progress data yet. Start studying to track your progress!</div>
              )}
          ...
          <div className="bg-white rounded-2xl border border-gray-100 shadow-sm p-5">
            ...
            <div className="space-y-3">
              {achievements.length === 0 && (
                <div className="text-center text-gray-400 text-sm py-4">Complete study tasks to earn achievements!</div>
              )}
